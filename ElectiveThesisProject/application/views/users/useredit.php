			  ...
			  <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         ...
                         <?php foreach ($user as $datas => $data): ?>  
                            	<div class="form-group">
                                	<label>Username</label>
                                	<input type="hidden" name="userID" class="form-control" id="userID"  value="<?php echo $data->userID;?>" />                                	 	
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="userPASSWORD" class="form-control" id="userPASSWORD" value="<?php echo $data->userPASSWORD;?>" />
                                    <span class="alert-danger" id="err-userPASSWORD"></span>
                                </div>
                                <div class="form-group">
                                    <label>Employee Complete Name</label>                                                                    
                                    <input type="text" name="employeeName" class="form-control" id="employeeName" value="<?php echo $data->employeeName;?>" />
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="table-bnt" href="<?php echo base_url() . "users/deleteUser/" . $data->userID; ?>">
                                                <button type="button" class="btn btn-danger btn-xs">Delete</button>
                                                </a>
                                                <a href="<?php echo base_url() . "users/editUser/" . $data->userID; ?>">
