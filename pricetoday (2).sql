...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2016 at 05:36 PM
...
CREATE TABLE IF NOT EXISTS `province_price_update` (
  ...
  `province_updateID` int(11) DEFAULT NULL,
  `productID` int(11) NOT NULL,
  `price` int(11) NOT NULL,
  `unitofmeasure` int(11) NOT NULL,
  PRIMARY KEY (`province_price_updateID`),
  KEY `FK__province_update` (`province_updateID`),
...
INSERT INTO `province_update` (`province_updateID`, `date`, `status`, `placeID`, `userID`) VALUES
(1, '2016-01-16', 'Uploaded', 5, NULL),
(2, '2016-01-16', 'Uploaded', 6, NULL),
(3, '2016-01-16', 'Uploaded', 7, NULL),
(4, '2016-01-16', 'Uploaded', 8, NULL),
(5, '2016-01-16', 'Uploaded', 9, NULL);
...
ALTER TABLE `province_price_update`
  ...
  ADD CONSTRAINT `FK__province_update` FOREIGN KEY (`province_updateID`) REFERENCES `province_update` (`province_updateID`),
